...
module.exports = (env, argv) => {
  ...
  const copyPlugin = new CopyPlugin({
    patterns: [
      ...
      { from: "./src/images/screenshot_full_720_1280.png", to: "./assets/screenshot_full_720_1280.png" },
      { from: "./src/images/screenshot_full_1080_1080.png", to: "./assets/screenshot_full_1080_1080.png" },
      { from: "./src/images/screenshot_hint_720_1280.png", to: "./assets/screenshot_hint_720_1280.png" },
      { from: "./src/images/screenshot_hint_1080_1080.png", to: "./assets/screenshot_hint_1080_1080.png" },
      { from: "./src/images/screenshot_new_720_1280.png", to: "./assets/screenshot_new_720_1280.png" },
      { from: "./src/images/screenshot_new_1080_1080.png", to: "./assets/screenshot_new_1080_1080.png" },
      { from: "./src/images/screenshot_partial_720_1280.png", to: "./assets/screenshot_partial_720_1280.png" },
      { from: "./src/images/screenshot_partial_1080_1080.png", to: "./assets/screenshot_partial_1080_1080.png" },
